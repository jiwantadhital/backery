...
class AppColors{
  static final Color kPrimaryColor = const  Color(0xFFFF7643);
   static final Color kSecondaryColor = const Color(0xFF979797);
  static final Color kSilver =const Color(0xFFF6F6F6);
