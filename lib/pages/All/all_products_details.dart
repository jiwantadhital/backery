...
int pageId;
AllProductDetails({required this.pageId});
  @override
  Widget build(BuildContext context) {
    var product = Get.find<AllProductController>().allProductList[pageId];
    Get.find<AllProductController>().initProduct(product,Get.find<CartController>());
    return Scaffold(
      body: Column(
        children: 
          [
                ...
                [
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      fit: BoxFit.cover,
                      image: NetworkImage(
                        AppConstants.BASE_URL+'/assets/images/'+product.photo.toString()
                      ),
                      )
                  ),
                        ),
                          ...
                          GetBuilder<AllProductController>(builder: ((controller) {
                            return Stack(
                              children: [
                                ...
                                Get.find<AllProductController>().totalItems>=1?
                                Positioned(
                                  right: 0,top: 0,
                                ...
                                Positioned(
                                  right: 5,top: 3,
                                  child: BigText(text: Get.find<AllProductController>().totalItems.toString(),
            ...
            child: Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  ExpandableTextWidget(text: product.sortDetails!)
                ],),
              ),
            )
          )
      ...
      bottomNavigationBar: GetBuilder<AllProductController>(builder: (allProduct){
        return Container(
        height: 120,
          ...
          children: [
            Container(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 5,),
                  BigText(text: allProduct.inCartItems.toString(),color: Colors.black,),
                  SizedBox(width: 5,),
                  GestureDetector(
                    onTap: () {
                      allProduct.setQuantity(true);
                    },
            ...
            Container(
              ...
              child: GestureDetector(
                onTap: (){
                  allProduct.addItem(product);
                },
                child: BigText(text: "\$${product.discountPrice} | Add to Cart",color: Colors.white,)),
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(20),
                color: Colors.orange,
              ),
